...
export class ReporteMembresiaPagosComponent implements OnInit {
  columnas: TableColumn<ReportePagoMembresiaData>[] = [
    ...
    { clave: 'fecha', etiqueta: 'Fecha pago', tipo: 'date', ordenable: true, filtrable: false, visible: true, sumable: false },
    ...
    { clave: 'fechahoraregistro', etiqueta: 'Fec. hora registro', tipo: 'date', ordenable: true, filtrable: false, visible: false, sumable: false },
    { clave: 'fechaultimaactualizacion', etiqueta: 'Fec. actualización', tipo: 'date', ordenable: true, filtrable: false, visible: false, sumable: false },
