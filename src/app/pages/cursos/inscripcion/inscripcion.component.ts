...
import { AgregarestudianteComponent } from '../../estudiantes/agregarestudiante/agregarestudiante.component';
...
export class InscripcionComponent implements OnInit, OnDestroy {
  ...
  abrirDialogCrearEstudiante() {
    this.dialog.open(AgregarestudianteComponent)
  }
